...
void Boarder()
{
    ...
    for (i = BOX_X_START; i <= BOX_X_END; i++)
    {
        // --- top line ---
        GotoXY(i, 10);
        if(i==BOX_X_START) printf("%c",LT_CORNER);
        else if(i==BOX_X_END) printf("%c",RT_CORNER);
        else printf("%c",HORIZONTAL_LINE);

        // --- bottom line ---
        GotoXY(i, 30);
        if(i==BOX_X_START) printf("%c",LD_CORNER);
        else if(i==BOX_X_END) printf("%c",RD_CORNER);
        else printf("%c",HORIZONTAL_LINE);
    }
